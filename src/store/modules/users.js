...
export default {
	...
	getters: {
		...
		// userBarsCount: state => id => countObjectProperties(state.items[id].bars)
		// userFavoritesCount: state => id => countObjectProperties(state.items[id].favorites)
		// userStarsCount: state => id => countObjectProperties(state.items[id].)
	},
	actions: {
